...
public class UserDao extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "create table if not exists "+ TABLE_NAME
                ...
                + I.User.UID +" int unique not null, "
                + I.User.NICK +" varchar, "
    ...
    public UserBean findUserByUserName(String userName){
        ...
        if(c.moveToNext()){
            ...
            UserBean user = new UserBean(uid,"ok",userName,nick,password,avatar,latitude,longitude,unReaderMsgCount);
            return user;
        }
        return null;
    }
    ...
    public boolean updateUser(UserBean user){
        ...
        values.put(I.User.UN_READ_MSG_COUNT,user.getUnreadMsgCount());
        SQLiteDatabase db = getWritableDatabase();
        long rowId = db.update(TABLE_NAME,values,I.User.USER_NAME+ "=?",new String[]{user.getUserName()});
        return rowId>0;
    }
}
